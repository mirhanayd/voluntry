...
export default function OrganizerFeedPage() {
    ...
    <main style={mainArea}>
      ...
      <style>{`
        ...
        .f-glowRing2 {
          ...
          height: 480px;
          border-radius: 50%;
          border: 1.5px solid rgba(249, 115, 22, 0.06);
      ...
      <div className="feed-content-wrapper">
        <div className="feed-shell">
          <section>
            ...
            <div style={feedColumn}>
              ...
              {!loading &&
                ...
                posts.map((post) => (
                  <FeedCard
                    key={post.id || post.certificateId || Math.random().toString()}
                    post={post}
                  />
                ))}
            </div>
          ...
          <aside className="feed-right">
            <div style={sideCard}>
              <h3 style={sideTitle}>Create an Event</h3>
              <p style={sideSub}>
                Launch a new volunteering event and reach more students.
              </p>
              <Link href="/organizer/events/create" style={sideBtn}>
                + Create Event
              </Link>
              <div style={sideMeta}>
                <Link href="/organizer/events" style={sideLink}>
                  View My Events
                </Link>
              </div>
            </div>
            ...
            <div style={sideCardMuted}>
              <h4 style={sideSmallTitle}>Quick Tips</h4>
              <ul style={sideList}>
                <li>Add a cover image for better reach.</li>
                <li>Set clear point values for volunteers.</li>
                <li>Share completions to boost the feed.</li>
              </ul>
            </div>
          </aside>
        </div>
...
const sideSub: React.CSSProperties = {
  fontSize: 13,
  color: "#6b7280",
  margin: "0 0 14px",
  lineHeight: 1.5,
...
const sideSmallTitle: React.CSSProperties = {
  margin: "0 0 10px",
  fontSize: 13,
  fontWeight: 700,
  color: "#246344",
